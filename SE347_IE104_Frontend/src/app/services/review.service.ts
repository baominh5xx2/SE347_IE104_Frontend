...
export class ReviewService {
  ...
  /**
   * Get featured reviews for landing page (approved reviews, limit 5)
   */
  getFeaturedReviews(limit: number = 5): Observable<ReviewListResponse> {
    return this.getReviews({ is_approved: true, limit: limit });
  }
